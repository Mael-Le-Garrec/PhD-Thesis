...
%         SPINE
% -----------------------
\bookcovercomponent{center}{spine}[2mm, 0mm, 2mm, 0mm]{
    \noindent\rule[0.5em]{\partwidth}{1.5pt}
    \vfill
    \rotatebox[origin=c]{-90}{
        \large\bfseries\scshape{PhD Thesis -- LHC Effective Model For Optics Corrections -- Maël Le Garrec}
    }
    \vfill
    \noindent\rule[0.5em]{\partwidth}{1.5pt}
}
