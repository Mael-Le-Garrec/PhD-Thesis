...
Several measurements were taken at different working points to identify a configuration that allowed
...
%      Response Matrix
%-----------------------------
\subsection{\review{Response Matrix Construction}}
...
trend. The polar plot of \Cref{fig:skew_octupolar:response_correctors_polar}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.7\textwidth]{./images/losses_with_without_a4corr.pdf}
...
of the same RDT from $0K_4$ to $+2K_4$. It is evident that simulations including normal and
skew-octupolar field errors are not enough to explain the behaviour observed in the measurements.
