...
the measured observables, a set of corrector strengths is obtained that can replicate the measured
...
in chromaticity for a given strength. Chromaticity being linear with multipole strength, an affine
function can be determined for each axis.
\Cref{fig:corrections-dq3_versus_k5} shows a simulation with several MCD strengths, highlighting this
