...
$\delta$ are usually \textit{not} included in the term. This third order is mainly contributed to by
decapoles. It is related to the $\beta$-function, the dispersion and the strength of the multipole,
also shown in~\cref{eq:detuning_effects:chromaticity_strength}:
...
expansion, as detailed in~\todo{ref to $\alpha_c$ in concepts of accelerators}. It is assumed here 
though to be constant.
