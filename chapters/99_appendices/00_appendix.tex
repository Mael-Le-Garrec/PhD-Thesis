...
\addpart{Appendices}  % Add a page that separates the appendix from the rest
\EnableChapterthumb % Re-enable the thumbs, that will have "A", "B", etc.

% ==============================================================
%                 Hamiltonians and Transfer Maps
% ==============================================================
\chapter{\review{Hamiltonians and Transfer Maps}}
...
%              Hamiltonians
% ---------------------------------------
\section{\review{Hamiltonians of Elements}}

The Hamiltonian of a \textit{multipole} is the
following~\cite{tomas_direct_2003,franchi_studies_2006,keintzel_jacqueline_beam_2022}:
...
% --------- Generic Expression
\subsection{\review{Generic Effective Hamiltonian of Two Elements}}
...
A drift $D$ is put in between the two multipoles $H_1$ and $H_2$ to change the coordinates. This
results in non-zero Poisson brackets as the momentum is propagated,
...
% --------- Two sextupoles 
\subsection{\review{Transfer Map of Two Sextupoles}}
...
\subsection{\review{Transfer Map of a Sextupole and Octupole}}
...
\subsection{\review{Transfer Map of a Skew Quadrupole and Octupole}}
...
% ==============================================================
\chapter{\review{Chromatic Amplitude Detuning}}
...
% ==============================================================
\chapter{\review{Resonance Driving Terms}}
\label{appendix:rdts}
...
Several different RDTs can contribute to the same line, which can be observed in the horizontal or
...
According to \cref{eq:reminder_rdt} and \cref{eq:amplitude_fjklm}, it can be seen that many
...
% ==========================
%        Frequency
\section{\review{Frequency Spectrum Lines}}
...
% ==========================
%         RDT Table
\section{\review{Amplitude, Resonances and Lines}}
