...
\todo{The following derivations are just copy-pasted from notes}
...
\begin{equation}
  \begin{aligned}
  N_3 = \; &J_{x} K_{3} \beta_{x} \delta \eta \cos^{2}{\left(\phi_{x} \right)} - J_{y} K_{3} \beta_{y} \delta \eta \cos^{2}{\left(\phi_{y} \right)} \\
        &- \sqrt{2} J_{y} K_{3} \beta_{y} \sqrt{J_{x} \beta_{x}} \cos{\left(\phi_{x} \right)} \cos^{2}{\left(\phi_{y} \right)} + \frac{K_{3} \delta^{3} \eta^{3}}{6} \\
        &+ \frac{\sqrt{2} K_{3} \delta^{2} \eta^{2} \sqrt{J_{x} \beta_{x}} \cos{\left(\phi_{x} \right)}}{2} + \frac{\sqrt{2} K_{3} \left(J_{x} \beta_{x}\right)^{\frac{3}{2}} \cos^{3}{\left(\phi_{x} \right)}}{3}
  \end{aligned}
\end{equation}
...
\begin{equation}
  N_3 = \frac{1}{6\pi^2} K_{3} \cdot \left(3 \pi^{2} J_{x} \beta_{x} \delta \eta - 3 \pi^{2} J_{y} \beta_{y} \delta \eta + \pi^{2} \delta^{3} \eta^{3}\right)
\end{equation}
...
\begin{equation}
  \begin{aligned}
    \Delta Q_x &=   \frac{1}{4\pi} K_3 \beta_x \eta \delta L     \\
    \Delta Q_y &= - \frac{1}{4\pi} K_3 \beta_y \eta \delta L
  \end{aligned}
\end{equation}
...
The overall contribution of sextupoles to the Chromatic Amplitude Detuning is then the following:
...
\begin{aligned}
\left< N_4 \right> = \frac{1}{24} K_4 \biggl[& \frac{3}{2} J_x^2\beta_x^2 \\
...
\begin{equation}\begin{aligned}
Q_x = \frac{1}{2\pi} \frac{\partial \left< N_4 \right>}{\partial J_x} &= \frac{1}{48\pi} K_4 \biggl[3 J_x \beta_x^2
                                                                                                             +6 \beta_x \eta^2 \delta^2
                                                                                                             -6 \beta_x J_y  \beta_y 
                                                                                                      \biggr]\\
Q_y = \frac{1}{2\pi} \frac{\partial \left< N_4 \right>}{\partial J_y} &= \frac{1}{48\pi} K_4 \biggl[-6 J_x \beta_x \beta_y
...
Skipping the first steps detailed previously, the tune shift induced by a decapole is given by the
following:

\begin{equation}
  \begin{aligned}
    \Delta Q_x = \frac{1}{2\pi} \frac{\partial \left< N_5 \right>}{\partial J_x} &= \frac{1}{240\pi} K_5 \biggl[10 \eta^3 \delta^3 \beta_x
                                                                                                                  + 15 \eta \delta J_x \beta_x^2
                                                                                                                  - 30 J_y \beta_y \beta_x \eta \delta
                                                                                                          \biggr]\\
    \Delta Q_y = \frac{1}{2\pi} \frac{\partial \left< N_5 \right>}{\partial J_y} &= \frac{1}{240\pi} K_5 \biggl[-10 \eta^3 \delta^3 \beta_y
...
cross-terms between $\delta$ and the action now appear, giving rise to the "proper" chromatic
amplitude detuning.
