...
\setkomafont{section}{\fontspec{Tex Gyre Adventor}\Large\bfseries}
\setkomafont{subsection}{\fontspec{Tex Gyre Adventor}\large\bfseries}
\setkomafont{subsubsection}{\fontspec{Tex Gyre Adventor}\normalsize\bfseries}
\setkomafont{paragraph}{\fontspec{Tex Gyre Adventor}\small\bfseries}
\setkomafont{pagenumber}{\normalfont\fontspec{Tex Gyre Adventor}\small}
% fonts for the TOC
