...
Dodecapolar correctors being only present at the IPs, in a dispersion suppressed zone, only the
RDTs could be acted upon, not the chromaticity. In the absence of crossing angles, and thus
feed-down to amplitude detuning, the dodecapolar correctors could be trimmed individually to observe
the change in lifetime and RDT, and perhaps consider corrections.