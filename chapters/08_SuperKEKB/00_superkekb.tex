...
the vertical plane is shown in \cref{fig:kek:rdt_spectrum_HER}. The frequency line $-1Q_x - 1Q_y$ is
seen at each BPM. Additionally, lines near the vertical tune are attributed to the synchrotron tune.
