...
be achieved with the Turn-By-Turn method, a measurement campaign has been carried out to improve the
...
action.
The tune is computed across each kick using a window of 200 turns, every 50 turns. A clear trend 
...
that simulated, of $600$. This observed discrepancy indicates possible un-modeled octupolar-like sources.
