...
\todo{
Indices for K and b.\\
J for action and and skew field.\\
Normal and skew field Hamiltonian.\\
reference radius = 0.017m
}
...
equation~\ref{eq:magnetic_field_relative_errors}. The coefficients of the normal and skew relative 
...
\begin{equation}
    B_y + iB_x = 
        ...
        \end{cases}
    \label{eq:magnetic_field_relative_errors}
\end{equation}
...
%              Normalization
% ============================================
\subsection{Beam Rigidity and Normalization}
...
dipoles in the machine. It can be calculated via the radius of curvate: $f = \rho / r$. A low 
