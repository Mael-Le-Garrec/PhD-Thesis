...
A general formula can be found for the chromaticity of order $n, n > 2$, relating a chromaticity of
order $n$ with a multipole of order $n+2$:
...
expected to retrieve those terms here as well.
