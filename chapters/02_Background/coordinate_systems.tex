...
\subsection{Non-Linear Transfer of one Sextupole}

Here, we are interested on the effect of a single sextupole of the coordinates.
Let's consider a sextupole with strength $K_3$ and a normal field
$N_3 = \frac{1}{6} K_3 (x^3 - 3xy^2)$.
...
\paragraph{$x$ via power series}

\begin{equation}
  e^{L:N_3:} x = x + [L \cdot N3, x]
\end{equation}
...
\begin{equation}
  \begin{aligned}
    [L \cdot N_3, x] =& \overbrace{\frac{\partial (L \cdot N_3)}{\partial x} \frac{\partial x}{\partial p_x}}^{0} -
...
Final equation for $x$, similar for $y$
\begin{equation}
  \begin{aligned}
    \Rightarrow e^{L:N_3:} x &= x \\
                e^{L:N_3:} y &= y \\
  \end{aligned}
\end{equation}


\paragraph{$p_x$ via power series}

\begin{equation}
  e^{L:N_3:} p_x = x + [L \cdot N3, p_x]
\end{equation}
...
\begin{equation}
  \begin{aligned}
    [L \cdot N_3, p_x] =& \frac{\partial (L \cdot N_3)}{\partial x} \frac{\partial p_x}{\partial p_x} -
...
Final equation for $p_x$ and $p_y$
\begin{equation}
  \begin{aligned}
    \Rightarrow e^{L:N_3:} p_x &= p_x + \frac{1}{2} K_3 L (x^2 - y^2) \\
                e^{L:N_3:} p_y &= p_y - K_3 L xy
  \end{aligned}
\end{equation}
