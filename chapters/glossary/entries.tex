...
\newglossaryentry{Chromatic Amplitude Detuning}{
    ...
    description={
        ...
        offset. Corrected via decapoles to the first order.
    }
}
...
\newglossaryentry{FeedUp}{
    ...
    name=Feed-up,
    description={
        Higher-order-like effects induced by a combination of lower-order multipoles.
    }
}
\newglossaryentry{Orbit}{
    ...
    name=Closed orbit,
    description={
        Path of the reference particle through the accelerator, closing back on itself.
    }
}
\newglossaryentry{Laundau Octupole}{
    ...
    description={
        ...
        amplitude detuning helps suppress the coherent instabilities of many particles.
    }
}
\newglossaryentry{Crosstalk}{
    ...
    name=Crosstalk, 
    description={
        Unwanted magnetic interference between adjacent magnetic circuits.
    }
}
...
\newglossaryentry{Aperture}{
    ...
    name=Aperture,
    description={
        Physical aperture, i.e. where the beam can pass, of an element in the accelerator.
    }
}
...
\newglossaryentry{Betatron coupling}{
    ...
    name=Coupling,
    description={
        Coupling of a particle's motion in the transverse planes. Corrected via skew quadrupoles to
        the firs, linear, order.
    }
}
...
\newglossaryentry{Online}{
    ...
    name=Online,
    description={
        Refers to actions, often corrections, performed in the control room during measurements,
        where time is limited. Opposed to \textit{offline}.
    }
}
...
\newacronym{ip}{IP}{
    Interaction Point -- Center of the straight sections of the LHC. Beams collides in four of them
    where they cross (IP1, 2, 5, 8).
}
\newacronym{ir}{IR}{
    Insertion Region -- Part of the straight sections, between the dispersion suppressors. The IP
...
\newglossaryentry{brho}{
    ...
    name={$B \rho$},
    description={
        Magnetic rigidity -- Quantifies the ability of a field to deviate a particle $[\text{Tm}]$.
    }
}
\newglossaryentry{cminus}{
    ...
    name=$|C^-|$,
    description={
        Minimum tune separation -- Global quantification of the linear coupling $[1]$.
    }
}
\newglossaryentry{Jn}{
    type=symbols,
...
\newglossaryentry{DQ}{
    ...
    name=$Q^{(n)}$,
    description={
        Chromaticity of order $n$ -- Orders up to three are generally denoted $Q'$, $Q''$ and $Q'''$ $[1]$.
    }
}
...
\newglossaryentry{rdt_fjklm}{
    ...
    name=$f_{jklm}$,
    description={
        Resonance Driving Term -- Specific term related to a multipole of order
        $n\!=\!j\!+\!k\!+\!l\!+\!m$ $[\text{m}^{-n/2+1}]$.
    }
}
\newglossaryentry{delta}{
    ...
    name=$\delta$,
    description={
        Momentum offset -- Deviation of a particle's momentum relative to the reference one $[1]$.
    }
}
\newglossaryentry{Tune}{
    ...
    name=$Q$,
    description={
        Tune -- Number of betatron oscillations per turn in a circular accelerator $[1]$.
    }
}
