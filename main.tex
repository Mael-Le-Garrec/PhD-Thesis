...
% Wider bars than \bar but smaller than \overline
\newcommand*\xbar[1]{%
   \hbox{%
     \vbox{%
...
\geometry{a4paper, top=2.5cm, left=2cm, right=2cm, bottom=2.5cm, includehead, includefoot}

% For headers and footers
\usepackage{fancyhdr}
\lhead{\leftmark}
\rhead{Page \thepage\ on \getpagerefnumber{End}}
\lfoot{CERN}
\rfoot{BE-ABP-LNO / OMC}
...
% Setup an unicode font for regular typing and for maths
...
% Custom command to create highlights easily in colors
